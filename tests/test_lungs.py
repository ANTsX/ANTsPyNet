...
class Test_lung_extraction_ct(unittest.TestCase):
    ...
    def test_example(self):
        ct_file = tf.keras.utils.get_file(fname="ctLung.nii.gz", origin="https://ndownloader.figshare.com/files/42934234")
...
class Test_lung_extraction_proton(unittest.TestCase):
    ...
    def tearDown(self):
        pass
    def test_example(self):
        proton_file = tf.keras.utils.get_file(fname="protonLung.nii.gz", origin="https://ndownloader.figshare.com/files/42934228")
...
class Test_lung_extraction_cxr(unittest.TestCase):
    ...
    def tearDown(self):
        pass
    def test_example(self):
        cxr_file = tf.keras.utils.get_file(fname="cxr.nii.gz", origin="https://ndownloader.figshare.com/files/42934237")
...
class Test_lung_extraction_ventilation(unittest.TestCase):
    ...
    def tearDown(self):
        pass
    def test_example(self):
        ventilation_file = tf.keras.utils.get_file(fname="ventilationLung.nii.gz", origin="https://ndownloader.figshare.com/files/42934231")
