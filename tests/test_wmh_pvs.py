...
class Test_sysu_wmh(unittest.TestCase):
    ...
    def test_example(self):
        t1_file = tf.keras.utils.get_file(fname="t1.nii.gz", origin="https://ndownloader.figshare.com/files/40251796")
        t1 = ants.image_read(t1_file)
        flair_file = tf.keras.utils.get_file(fname="flair.nii.gz", origin="https://ndownloader.figshare.com/files/40251793")
...
class Test_shiva_wmh(unittest.TestCase):
    ...
    def tearDown(self):
        pass
    def test_example(self):
        t1_file = tf.keras.utils.get_file(fname="pvs_t1.nii.gz", origin="https://ndownloader.figshare.com/files/48675367")
        t1 = ants.image_read(t1_file)
        flair_file = tf.keras.utils.get_file(fname="pvs_flair.nii.gz", origin="https://ndownloader.figshare.com/files/48675352")
        flair = ants.image_read(flair_file)
